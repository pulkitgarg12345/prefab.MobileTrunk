...
with open("/home/fabrice/Documents/CRIStAL/prefab.MobileTrunk/test/join_states_data_processing/record_join_states/read_summit_xl_joint_states.txt", "r") as f:
...
fc_modifiee = 1.5 # nouvelle fréquence de coupure
...
for i in range(4):
    ...
    ax.plot(digital_twin_dt, digital_twin_speed[i], label=f"digital_twin angular_speed{i+1} - filtre")
    ax.plot(summit_xl_dt ,  summit_xl_speed[i], label=f"Summit_xl angular_speed{i+1} - filtre")
